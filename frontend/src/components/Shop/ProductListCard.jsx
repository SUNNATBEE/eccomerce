...
const ProductListCard = ({ product }) => {
  return (
    <div className="flex flex-col md:flex-row gap-6 bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-lg transition-all group">
      {/* Rasm qismi */}
      <div className="relative w-full md:w-64 h-48 bg-gray-50 rounded-xl overflow-hidden flex-shrink-0">
        {product.badge && (
      ...
      <div className="flex-1 flex flex-col">
        ...
        <p className="text-gray-500 text-sm line-clamp-2 mb-4 flex-1">
          {product.description || "Mahsulot haqida qisqacha ma'lumot mavjud emas."}
        </p>
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-colors">
